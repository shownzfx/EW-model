...
to adapt-strategy
  if choose-strategy = "rememberFrequency" [ ; remember EW by frequency it happens
    adapt-by-EWfreq
  ]
...
to take-damage
  set currentDamage random ExtremeWeatherDamage
...
"pen-1" 1.0 0 -8053223 true "" "plot mean [currentDamage] of serviceArea"
